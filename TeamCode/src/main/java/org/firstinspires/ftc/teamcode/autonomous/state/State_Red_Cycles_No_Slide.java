...
//
        ...
        TrajectorySequence top = drive.trajectorySequenceBuilder(new Pose2d(10, -65, Math.toRadians(270)))
                ...
                .splineToSplineHeading(new Pose2d(44, -68, Math.toRadians(0)),0)
                .waitSeconds(0.2)
                .addTemporalMarker(() -> {
                    Intake.setPower(-1);
                    Twist.setPosition(0.6D);
                ...
                .splineToSplineHeading(new Pose2d(-12, -52, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
                ...
                .splineToSplineHeading(new Pose2d(-12, -53, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
                ...
                .splineToSplineHeading(new Pose2d(47, -70, Math.toRadians(0)),0)
                .waitSeconds(0.2)
                .addTemporalMarker(() -> {
                    Intake.setPower(-1);
                    Twist.setPosition(0.6D);
                ...
                .splineToSplineHeading(new Pose2d(-12, -54, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
                 ...
                 */
                .build();
        TrajectorySequence middle = drive.trajectorySequenceBuilder(new Pose2d(10, -65, Math.toRadians(270)))
                .setReversed(true)
                .UNSTABLE_addTemporalMarkerOffset(0.25, () -> {
                    Intake.setPower(1);
                ...
                .splineToSplineHeading(new Pose2d(-12, -49, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
                ...
                .splineToSplineHeading(new Pose2d(-12, -51, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
                 ...
                 */
                .build();
        TrajectorySequence bottom = drive.trajectorySequenceBuilder(new Pose2d(10, -65, Math.toRadians(270)))
                .setReversed(true)
                .UNSTABLE_addTemporalMarkerOffset(0.25, () -> {
                    Intake.setPower(1);
                ...
                .splineToSplineHeading(new Pose2d(-12, -50, Math.toRadians(270)), Math.toRadians(90))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    Twist.setPosition(0.84D);
                })
