...
@Autonomous(name = "State Red Cycles No Slides Preload", group = "State", preselectTeleOp = "MAIN MECANUM DRIVE")
public class State_Red_Preload_Only extends LinearOpMode {
    DcMotorEx LF;
    DcMotorEx RF;
    DcMotorEx RB;
    DcMotorEx LB;
